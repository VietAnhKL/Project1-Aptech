...
<table width="900" border="0" cellspacing="40" cellpadding="15">
  <tbody><tr>
    <td>Title</td>
    <td><input type="text" name="name" id="tieu_de" size="30"></td>
  </tr>
  <tr>
    <td>Description</td>
  ...
  <tr style="margin-bottom:20px">
   ...
   <tr>
    <td>Date</td>
    <td><input type="text" name="ngay_dang" id="ngay_dang" class="hasDatepicker"></td>
  </tr>
   <tr>
    <td>Ngày Gửi</td>
    <td><input type="text" name="ngay_gui" id="ngay_gui" class="hasDatepicker"></td>
  </tr>
   <tr>
    <td>Số lượt xem</td>
